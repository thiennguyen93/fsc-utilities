...
{{< img src="/images/input-milage-directly.png" alt="Transfer mileage directly from FSC Rater" caption="<em>Transfer mileage directly from FSC Rater</em>" class="border-0" >}}
